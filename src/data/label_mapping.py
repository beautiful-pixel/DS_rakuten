"""
Label Mapping - Canonical Classes Definition (Phase 2)

This module provides the single source of truth for class labels across all models.
CANONICAL_CLASSES defines the fixed order for all model outputs (probs[:, i] corresponds to CANONICAL_CLASSES[i]).

Usage:
    from src.data.label_mapping import CANONICAL_CLASSES, CANONICAL_CLASSES_FP
    from src.data.label_mapping import reorder_probs_to_canonical
"""
...
# ============================================================================
# MODULE-LEVEL CONSTANTS (Lazy load with clear error)
# ============================================================================
